            ...
            <nav className="mx-auto flex max-w-{1180px} items-center justify-between px-6 py-5">
                ...
                <div className="flex items-center gap-1">
                    <div className="flex items-center gap-0">
                        <img src="./src/assets/logo.svg" alt="TalentDesk Logo" className="h-10 w-10 object-contain" />
                        <span className="font-bold text-[#f5f1ea]">
                            Talent<span className="text-[#ff6b2c]">Desk</span>
                        </span>
                    </div>
                    <div className="flex items-center ">
                        <span className="ml-4 text-xs font-semibold tracking-[0.18em] text-[#9b9b96]">
                            HIRING WORKSPACE
                        </span>
                    </div>
                    </div>
                    ...
                    <div className="flex items-center gap-8">
                        <a
                            href="#pipeline"
                            className="text-sm font-medium text-[#b8b6b0] transition hover:text-white"
                        >
                            Pipeline
                        </a>
